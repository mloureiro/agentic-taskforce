...
```bash
git checkout main
git checkout -b mloureiro/{{task-name}}/{{agent-name}}
```
...
git checkout -b mloureiro/{{task-name}}/shared
```
...
# API agent first
git checkout main
git checkout -b mloureiro/{{task-name}}/api

# FE agent branches from API branch
git checkout mloureiro/{{task-name}}/api
git checkout -b mloureiro/{{task-name}}/frontend
```
...
# Phase 1
git checkout main
git checkout -b mloureiro/{{task-name}}/phase1

# Phase 2 (after phase 1 complete)
git checkout mloureiro/{{task-name}}/phase1
git checkout -b mloureiro/{{task-name}}/phase2-feature-a
```
...
Branch: mloureiro/big-feature/phase1
...
Branch: mloureiro/auth-feature/red
Commit: abc123
