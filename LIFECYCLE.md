...
5. **Post JOIN message:**
   ...
   Branch: ${TF_BRANCH_PREFIX:+$TF_BRANCH_PREFIX/}{{task-name}}/{{name}}
   ```
...
7. **Create your branch:**
   ...
   git checkout -b ${TF_BRANCH_PREFIX:+$TF_BRANCH_PREFIX/}{{task-name}}/{{name}}
   ```
...
3. **Post DONE:**
   ...
   - Branch: ${TF_BRANCH_PREFIX:+$TF_BRANCH_PREFIX/}{{task-name}}/red
   - PR: #1234 (if created)
